...
My name is Daniel and at the time of this writing I am a 26 year old "computer science grad student":http://www.uni-freiburg.de and a "developer for embedded systems":http://www.stzedn.de. I am a happy unix user ever since I made the switch away from Windows in the first year of my undergraduate study. "FreeBSD":http://www.freebsd.org for server tasks and "Mac OS X":http://www.apple.com/macosx for everything else to be exact. My main machine is a black MacBook from early 2008, perfectly paired with an iPhone 3G for mobile tasks.
